...
class MeetingFormTest(TestCase):
    def test_form(self):
        form= MeetingForm(data={'meetingTitle': "First Meeting",'meetingDate':"1989-09-18", 'meetingTime':"20:45", 'meetingLocation':"India", 'meetingAgenda':"xyz"})   
        self.assertTrue(form.is_valid())

class ResourceFormTest(TestCase):
    def test_form(self):
        user= User.objects.create(username='ok', password='dxy')
        form= ResourceForm(data={'resourceName': "First Meeting",'resourceType':"xyz",'resourceURL':"https://congerprep.blogspot.com/2019/03/forms-and-form-tests.html",'dateEntered':"1989-09-18",'userID':user, 'description':"xyz"})   
        self.assertTrue(form.is_valid())
